...
// Using let
let name = "Mobaraq Camar"; // Define a string here, e.g., "Juan Cruz"
let age = 21; // Define a number here, e.g., 30
let isStudent = true; // Define a boolean here, e.g., true or false
let hobbies = ["Gaming, Watching, Coding"]; // Define an array here, e.g., ["reading", "gaming", "coding"]
...
const birthYear = 2003; // Define a number here, e.g., 1990
const isEmployed = false; // Define a boolean here, e.g., true or false
const favoriteBooks = ["Moby-Dick, 1984, Brave New World"]; // Define an array here, e.g., ["1984", "Brave New World", "Fahrenheit 451"]
...
// Using var
var city = "Quezon City"; // Define a string here, e.g., "New York"
var temperature = 22.5; // Define a number here, e.g., 22.5
var hasPets = true; // Define a boolean here, e.g., true or false
var colors = ["Black, Green, Red"]; // Define an array here, e.g., ["red", "green", "blue"]
